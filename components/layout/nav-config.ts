...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/english", label: "英文阅读", en: "English", icon: Languages },
  { href: "/meditation", label: "冥想", en: "Meditation", icon: Brain },
  { href: "/research", label: "论文", en: "Research", icon: FlaskConical },
  { href: "/experiment", label: "实验", en: "Experiment", icon: Microscope },
